...
public class EventosActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //buscarRegistro("https://politecnico-estella.ddns.net:10443/masterchef/eventos_buscar_eventos.php?estado=" + "En curso");
        ...
        eventosPasados.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //buscarRegistro("https://politecnico-estella.ddns.net:10443/masterchef/eventos_buscar_eventos.php?estado=" + "Finalizado");
